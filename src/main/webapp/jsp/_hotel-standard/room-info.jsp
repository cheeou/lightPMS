...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/_hotel-standard/room-info.js'/>"></script>
    </jsp:attribute>
    <jsp:body>
                ...
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        <ax:td label='객실타입' width="300px">
                            <ax:common-code groupCd="PMS_ROOM_TYPE" id="roomTypCd" clazz="js-roomTypCd" dataPath="roomTypCd" emptyText="전체"/>
                        </ax:td>
                    </ax:tr>
                </ax:tbl>
            </ax:form>
