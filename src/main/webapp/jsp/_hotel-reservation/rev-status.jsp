...
<ax:layout name="base">
    <jsp:attribute name="script">
        <script type="text/javascript" src="<c:url value='/assets/js/view/_hotel-reservation/rev-status.js'/>"></script>
    </jsp:attribute>
    <jsp:body>
                    ...
                    <div data-ax-td style="width:100%">
                        <div data-ax-td-label>상태</div>
                            <div data-ax-td-wrap>
                                ...
                                <ax:common-code groupCd="PMS_STAY_STATUS" name="sttusCd" type="checkbox" />
                            </div>
                    </div>
                    </div>
                </div>
