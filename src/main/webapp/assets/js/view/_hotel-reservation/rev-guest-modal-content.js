...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                { key: 'guestNm', label: '이름', width: 160, align: 'center' },
                { key: 'guestTel', label: '연락처', width: 200, align: 'center' },
                { key: 'email', label: '이메일', width: 100, align: 'center' },
                { key: 'gender', label: '성별', width: 100, align: 'center' },
