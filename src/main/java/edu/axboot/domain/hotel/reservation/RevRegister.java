...
@Entity
@Table(name = "PMS_CHK")
public class RevRegister extends BaseJpaModel<Long> {
	...
	@Column(name = "SNO", length = 10, nullable = false)
	@Comment(value = "일련번호")
	private int sno;
	...
	private List<RevMemo> memos;

	@Builder
	public RevRegister(Long id, String rsvDt, int sno, String rsvNum, Long guestId, String guestNm, String guestNmEng,
					   String guestTel, String email, String langCd, String arrDt, String arrTime, String depDt,
					   String depTime, Integer nightCnt, String roomTypCd, String roomNum, Integer adultCnt,
					   Integer chldCnt, String saleTypCd, String sttusCd, String srcCd, String brth, String gender,
