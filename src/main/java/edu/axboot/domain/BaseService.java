...
import edu.axboot.domain.hotel.reservation.QRevRegister;
import edu.axboot.domain.hotel.reservation.memo.QRevMemo;
import edu.axboot.domain.hotel.room.QRoomInfo;
...
public class BaseService<T, ID extends Serializable> extends AXBootBaseService<T, ID> {
    ...
    protected QRevRegister qRevRegister = QRevRegister.revRegister;
    protected QGuest qGuest = QGuest.guest;
    protected QRevMemo qRevMemo = QRevMemo.revMemo;
    //-------------------------//
    public BaseService() {
        super();
    }
